...
\begin{document}
 ...
 About my calculations, I would like to say that all my calculations eered on the safe side. In all heating examples I was very careful to assume worst case voltage and current leading to worst case heating. 
 }
\\
\\
{\centering
