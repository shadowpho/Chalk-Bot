...
Integrated diagnostics provide warnings of undervoltage, overtemperature [only on controller], overcurrent, overvoltage, power bridge faults and short circuits. The CB01 is provided in a 1.2"x1.7" footprint module with logical pinouts and motor screw terminals.
\end{minipage}
} %end mbox
\\
\hspace{0.3in}
